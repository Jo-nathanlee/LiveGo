...
$(document).ready(function () {  
	$("#member_wrapper .row:nth-child(3) .col-md-7").addClass("col-md-12"); 
	$("#member_wrapper .row:nth-child(3) .col-md-5").css({'position':'absolute','margin-top':'-6px'}); 
	$("#member_wrapper .row:nth-child(2) .col-sm-12 table").prepend("<div class='col-sm-12 ba_W'></div>");
	$("#order_detail_wrapper .row:nth-child(3) .col-md-7").addClass("col-md-12"); 
	$("#order_detail_wrapper .row:nth-child(3) .col-md-5").css({'position':'absolute','margin-top':'-6px'}); 
	$("#order_detail_wrapper .row:nth-child(2) .col-sm-12 table").prepend("<div class='col-sm-12 ba_W'></div>");
});  