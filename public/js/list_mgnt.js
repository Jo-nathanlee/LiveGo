...
$(document).ready(function () {
    ...
    var language_list_edit = {
        "sProcessing": "處理中...",
        "sLengthMenu": " <button type='button' id='d_edit' onclick='change_status(event)' class='btn btn-info mr-1'>更改訂單狀態</button>_MENU_ 顯示筆數",
        "sZeroRecords": "沒有結果",
        "sInfo": " 顯示第 _START_ 至 _END_ 項結果，共 _TOTAL_ 項",
        "sInfoEmpty": "顯示第 0 至 0 項結果，共 0 項",
        "sInfoFiltered": "(由 _MAX_ 項結果過濾)",
    ...
    $(document).ready(function () {
        ...
        //     alertify.confirm('更改訂單狀態', '<select class="custom-select" id="select_statue"><option selected>選取更改訂單狀態</option><option value="1">未付款</option><option value="2">等待出貨中</option><option value="3">運送中</option><option value="4">訂單完成</option><option value="5">訂單取消</option></select>', function(){ alertify.success('Ok') }
